"""Contains the implementation of deep neural network for face reconstruction
model.

This file is mostly borrowed from:

https://github.com/sicxu/Deep3DFaceRecon_pytorch/blob/master/models/networks.py
...
def define_net_recon(net_recon, use_last_fc=False, init_path=None):
    return ReconNetWrapper(net_recon,
