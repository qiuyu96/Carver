# python3.8
"""Defines loss functions for VolumeGAN training."""
...
__all__ = ['VolumeGANLoss']


class VolumeGANLoss(BaseLoss):
    """Contains the class to compute losses for training VolumeGAN."""
    ...
    def __init__(self, runner, d_loss_kwargs=None, g_loss_kwargs=None):
        ...
        if runner.enable_amp:
            raise NotImplementedError('VolumeGAN loss does not support '
