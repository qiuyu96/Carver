# python3.8
"Configuration for training EG3D."
...
GENERATOR = 'EG3DGenerator'
LOSS = 'EG3DLoss'

class EG3DConfig(BaseConfig):
    """Defines the configuration for training EG3D."""

    name = 'eg3d'
    hint = 'Train a EG3D model.'
    info = '''
To train a EG3D model, the recommended settings are as follows:
