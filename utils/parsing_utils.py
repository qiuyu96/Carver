...
__all__ = [
    ...
    'parse_list', 'IntegerParamType', 'FloatParamType', 'BooleanParamType',
    'IndexParamType', 'ListParamType', 'JsonParamType', 'DictAction'
]
...
class ListParamType(click.ParamType):
    """Defines a `click.ParamType` to parse lsit arguments."""
    ...
    def convert(self, value, param, ctx):  # pylint: disable=inconsistent-return-statements
        try:
            ...
            self.fail(f'`{value}` cannot be parsed as a list!', param, ctx)
